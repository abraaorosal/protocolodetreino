const CACHE='ah-physique-v4';
const ASSETS=['./','./index.html','./styles.css','./controls.css','./mobile.css','./app.js','./enhancements.js','./countdown.js','./favicon.svg','./manifest.webmanifest'];
